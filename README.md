...
CleanR is a fast, production grade data cleaning engine for the command line. Built for data analysts, data engineers, and anyone who works with messy real world files, it handles CSV, Excel, JSON, Parquet, and more.
